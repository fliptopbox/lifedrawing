...
var fs = require('fs'),
    ...
    server = http.createServer(function(_, response) {
    ...
    connection.on('message', function(message) {
        ...
        */
        ...
        value = /^[0-9]+$/g.test(value)
            ? Math.max(0, parseInt(value, 10) - 1)
            : value;
        ...
        switch (key) {
            ...
            case 'random':
                ...
                (filename = svgObject.name), (fileNumber = svgObject.no);
                ...
                fs.stat(filePath, function(err, stats) {
                    ...
                    getTextStream(filePath, stats.size, function(
                        err,
                        object,
                        eof
                    ) {
